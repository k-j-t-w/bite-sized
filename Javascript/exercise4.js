...
function smallWordHelper(sentence){
    ...
    sentenceArr.forEach(value => {
       if (value.length > 3){
        ...
        const newWord = noVowels.join('')
        newSentence.push(newWord);

       } else {
        newSentence.push(value.toUpperCase())
       }
    })
  ...
  console.log(smallWordHelper("hi my name is kai, and it's a beautiful day"))